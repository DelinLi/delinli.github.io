...
4. **Andriod**, 百度云盘分享链接: [https://pan.baidu.com/s/1c2tWi0g](https://pan.baidu.com/s/1c2tWi0g)  密码: iart 
...
#####Mac上设置示例：    
![OnMac](shadowsocks.mac.png =100x140)    
进入Sever Preferences,填写账号信息即可。   
#####Iphone 上设置示例：
![OnIphone](shadowsocks.iphone.jpeg =120x200)     
...
![OnMacDropbox](Dropbox_shadowscokets.png =200x140)
